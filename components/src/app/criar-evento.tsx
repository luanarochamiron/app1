...
export default function CriarEventoScreen() {
	const { userId, dataSelecionada } = useLocalSearchParams();
	...
	const salvarEvento = async () => {
		...
		try {
			...
			rota.push({ pathname: "/calendario", params: { userId } });
		} catch (error) {
	...
	return (
		<SafeAreaView style={styles.tela}>
			<ScrollView  contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
				<View>
					<BotaoVoltar titulo="Adicionar Tarefa" onPress={() => rota.push({ pathname: "/calendario", params: { userId } })} />
				</View>
