		...
		<SafeAreaView style={styles.tela}>
			<ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
				...
				<View style={styles.container}>
					...
					<ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scroll}>
						<TouchableOpacity style={styles.card} onPress={() => router.push({ pathname: "/pomodoro", params: { userId } })}>
						...
						<TouchableOpacity style={styles.card} onPress={() => router.push({ pathname: "/meusSimulados", params: { userId } })}>
						...
						<TouchableOpacity style={styles.card} onPress={() => router.push({ pathname: "/dicasEstudos", params: { userId } })}>
			...
			<View style={styles.menu}>
				<View style={styles.contentMenu}>
					...
					<TouchableOpacity style={styles.btnAgenda} onPress={() => router.push({ pathname: "/calendario", params: { userId } })}>
					...
					<TouchableOpacity style={styles.btnConfig} onPress={() => router.push({ pathname: "/configuracoes", params: { userId } })}>
