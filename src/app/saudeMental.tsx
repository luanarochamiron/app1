        ...
        <SafeAreaView style={styles.tela}>
             <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <View style={styles.content}>
                    <BotaoVoltar titulo="Sáude Mental" onPress={() => router.push({ pathname: "/menu", params: { userId } })} />
                </View>
                ...
                <View style={styles.containerCards}>
                    <TouchableOpacity style={styles.card} onPress={() => router.push({ pathname: "/respiracao", params: { userId } })}>
                        <Image
