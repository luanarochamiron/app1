...
import { Entypo } from "@expo/vector-icons"; // ícone opcional
...
export default function TelaDicaEstudos() {
    ...
    const [ativo, setAtivo] = useState("Unesp");
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scroll} ref={scrollRef}>
                        {materiasOrdenadas.map((item, i) => (
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    setAtivo(item);
                                    if (item === "Fuvste") router.push({ pathname: "/simuladosFuvest", params: { userId , usuarioAtual} });
                                    else if (item === "Enem") router.push({ pathname: "/meusSimulados", params: { userId, usuarioAtual } });
                                    else if (item === "Unesp") router.push({ pathname: "/simuladosUnesp", params: { userId , usuarioAtual} });
                                }}
                            >
                ...
                <View style={styles.containerCardImagem}>
                    <View style={styles.cardImagem}>
                        <Text style={[styles.textoCard, { fontFamily: "Poppins_600SemiBold" }]}>Unesp 2025</Text>
                        ...
                        <View style={styles.parteBranca}>
                            <TouchableOpacity
                                ...
                                onPress={() => Linking.openURL("https://documento.vunesp.com.br/documento/stream/Njg1NTY1NQ%3d%3d")}
                            >
                            ...
                            <TouchableOpacity
                                style={styles.btn}
                                onPress={() => Linking.openURL("https://documento.vunesp.com.br/documento/stream/Njg1NTY2MA%3d%3d")}
                            >
                    ...
                    <View style={styles.cardImagem}>
                        <Text style={[styles.textoCard, { fontFamily: "Poppins_600SemiBold" }]}>Unesp 2024</Text>
                        <Text style={[styles.descricao, { fontFamily: "Poppins_400Regular" }]}>
                        ...
                        <View style={styles.parteBranca}>
                            <TouchableOpacity
                                style={styles.btnEstatiscas}
                                onPress={() => Linking.openURL("https://documento.vunesp.com.br/documento/stream/NTM0MTAyMQ%3d%3d")}
                            >
                                <Entypo name="bar-graph" size={24} color="#5D64F5" />
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity
                                style={styles.btn}
                                onPress={() => Linking.openURL("https://documento.vunesp.com.br/documento/stream/NTM0MTAyMA%3d%3d")}
                            >
                                <Text style={[styles.textoBtn, { fontFamily: "Poppins_600SemiBold" }]}>Treinar</Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={styles.cardImagem}>
                        <Text style={[styles.textoCard, { fontFamily: "Poppins_600SemiBold" }]}>Unesp 2023</Text>
                        <Text style={[styles.descricao, { fontFamily: "Poppins_400Regular" }]}>
                        ...
                        <View style={styles.parteBranca}>
                            <TouchableOpacity
                                style={styles.btnEstatiscas}
                                onPress={() => Linking.openURL("https://documento.vunesp.com.br/documento/stream/MzE3NTk4NA%3d%3d")}
                            >
                                <Entypo name="bar-graph" size={24} color="#5D64F5" />
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity
                                style={styles.btn}
                                onPress={() => Linking.openURL("https://documento.vunesp.com.br/documento/stream/MzE3NTk4Mg%3d%3d")}
                            >
                                <Text style={[styles.textoBtn, { fontFamily: "Poppins_600SemiBold" }]}>Treinar</Text>
                            </TouchableOpacity>
                        </View>
