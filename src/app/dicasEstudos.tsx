			...
			<ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
				...
				<View style={styles.containerCard}>
					<TouchableOpacity
						...
						onPress={() => router.push({ pathname: "/dicasRedacao", params: { userId } })}
					>
					...
					<TouchableOpacity
						style={styles.cardsItem}
						onPress={() => router.push({ pathname: "/dicasInterpretacao", params: { userId } })}
					>
						<View style={styles.cardContentItem}>
					...
					<TouchableOpacity
						style={styles.cardsItem}
						onPress={() => router.push({ pathname: "/dicasLiteratura", params: { userId } })}
					>
						<View style={styles.cardContentItem}>
